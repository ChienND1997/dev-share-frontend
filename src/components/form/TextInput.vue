  ...
  <label class="block text-sm" :class="{ 'mt-4': !isFirstElement }">
    ...
    <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
      <span v-if="!isTextArea">
        ...
        />
        <button
          v-if="hasButtonLeft || hasButtonRight"
...
export default defineComponent({
  data() {
    return {
      textInputClasses: {
        "dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray":
          !this.isValid && !this.hasHint && !this.isInvalid && !this.isTextArea,
        "border-red-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red":
          this.isInvalid,
        "border-green-600 dark:text-gray-300 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green":
          this.isValid,
        "dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray":
          this.hasHint,
