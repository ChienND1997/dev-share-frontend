<template>
  ...
  <button
    ...
    aria-label="Menu"
  >
    <element-svg aria-hidden="true" :class="'w-6 h-6'" :view-box="'0 0 20 20'" :fill="'currentColor'" :pic="updatePic" />
  </button>
</template>
...
export default defineComponent({
  ...
  computed: {
    ...
    updatePic() {
      return (this.pic = this.isMobileSideMenuOpen ? "arrowLeft" : "hamburgerMenu");
    },
  },
  methods: {
